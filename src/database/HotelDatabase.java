...
rooms.add(new Room(202,new RoomType("Single",2000),new ArrayList<>(),Roomtypee.SINGLE));
rooms.add(new Room(115,new RoomType("Suite",4500),new ArrayList<>(),Roomtypee.SUITE));
